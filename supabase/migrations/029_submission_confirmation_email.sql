-- 029_submission_confirmation_email.sql
-- Adds the missing 'submission' notification INSERT to submit_enrollment_lead
-- so prospects receive a thank-you email after submitting the contact form.
-- Root cause: 007_multi_child_enrollment.sql rewrote this function but omitted
-- the prospect notification. 018 added it to the wrong overload.
