...
export function FacilitiesPage({ onRequestEnrollment }: FacilitiesPageProps) {
  return (
    <div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">The training floor</h2>
      ...
      <section className="py-20 bg-slate-50 border-y">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-2xl font-bold mb-3">Safety and cleanliness</h2>
          <p className="text-base text-muted-foreground mb-10 max-w-xl">
            We treat the facility the way we'd want our own kids' school treated.
            These aren't policies we invented for a webpage — they're just how we operate.
          </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-2xl font-bold mb-10">What the environment feels like</h2>
          ...
          <div className="grid md:grid-cols-2 gap-x-14 gap-y-8">
            {[
              ...
              },
              {
                ...
                body: 'Students address instructors formally and treat each other with respect. That tone is set from day one and consistently maintained — by us and by them.',
              },
            ].map(({ icon: Icon, heading, body }) => (
      ...
      <section className="py-20 bg-slate-50 border-y">
        <div className="container mx-auto px-6 max-w-4xl">
          <h2 className="text-2xl font-bold mb-3">See the space</h2>
          <p className="text-base text-muted-foreground mb-10">
            A few shots of the facility. The best way to see it is in person — come by during
            class hours any time.
          </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center max-w-lg">
          ...
          <Button size="lg" className="px-10 font-semibold shadow-sm" onClick={onRequestEnrollment}>
